...
namespace TestWebAppCoolName.DAL
{
    public class BlogRepository : IBlogRepository, IDisposable
    {
        ...
        {
            return _context.Blogs.Include(b => b.Tags).Where(b => b.Approved).OrderBy(c => c.Position).ToList();
        }
        public List<Blog> GetFirst3BlogPosts()
        {
            return _context.Blogs.Include(b => b.Tags).Where(b => b.Approved).OrderBy(c => c.Position).Take(3).ToList();
        }
